    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <Subtitle>I'm creating awesome web experiences for everyone.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Shadow Health"
              link="https://www.shadowhealth.com"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              I help create amazing simulations for future healthcare providers.
            </ProjectCard>
            <ProjectCard
              title="Flips"
              link="https://www.youtube.com/embed/RbUg1M-eMaM"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              Every once in a while, I get some free time to practice my flips.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          <Title>It's meh!</Title>
          <AboutHero>
            <Avatar src={avatar} alt="Eric Hosford" />
            <AboutSub>
              I grew up with a soldering iron in one hand and a single button mouse in the other one.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
            By the time I was a teenager, I had disassembled all the toys in the neighborhood and crashed a 
            Rolodex full of BBSs. My Timex Sinclair still remains undefeated in Tic Tac Toe. The volume on my CTR-41 
            is set correctly out of the box. LOAD "*",8,1 has always loaded the right game at the right time. My 
            current diassembly to repair ratio stands at 78%. If you are stuck in the MUD or need DOS tips, 
            give me a /ping hosfordotme on EFnet. 73-51!
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:eric@hosford.me">Hi</a> or stalk me on other sites:{' '}
            <a href="https://www.linkedin.com/in/eric-hosford/">LinkedIn</a> &{' '}
            <a href="https://www.facebook.com/eric.hosford/">Facebook</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 Eric Hosford
        </Footer>
      </Content>
